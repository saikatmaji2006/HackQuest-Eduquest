...
const registerUser = asyncHandler( async(req,res)=>{
    const {fullName,Email, UserName, password,linkedIn,gitHub,x,country,leetCode}=req.body
    console.log("Email: ",Email,"\n","password: ",password);
    if([fullName,Email, UserName, password, linkedIn,gitHub,country,leetCode].some((field)=>
    field?.trim() === "")
){
